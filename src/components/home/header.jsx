...
export function Header(){
  ...
  return(
    <motion.main transition={{duration: 0.3}} initial={{x: -300, opacity: 0}} animate={{x: 0, opacity: 1}} className="flex w-full flex-col">
      ...
      {menu&&<motion.div transition={{duration: 0.3}} initial={{y: -300, opacity: 0}} animate={{y: 0, opacity: 1}} className="fixed top-14 left-[50%] transform translate-x-[-50%] mx-auto md:w-full md:flex-row md:justify-between border p-3 justify-center items-center flex flex-col gap-2">
